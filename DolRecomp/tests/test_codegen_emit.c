...
const unsigned opcode_raw_count =
    (unsigned)(sizeof(opcode_raws) / sizeof(opcode_raws[0]));

#ifndef DOLRECOMP_OPCODE_SAMPLES_ONLY
int main(int argc, char** argv) {
    const int count = (int)opcode_raw_count;
    FILE* out = stdout;
